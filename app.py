...
plants_seed_file = 'models/plants_data/data.json'
if os.path.exists(plants_seed_file):
    insert_plants_data_from_json(plants_seed_file)
else:
    print(
        f"Warning: plants seed file '{plants_seed_file}' was not found. Skipping plants data import."
    )
